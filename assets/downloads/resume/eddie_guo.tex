...
\usepackage{amsmath, enumitem, graphicx, wrapfig}
...
\thispagestyle{plain}
% =================================== HEADER ===================================
\begin{wrapfigure}{R}{0.275\textwidth} \vspace{-0.95em}
...
\normalfont \normalsize
% (587) 988-0292 \hspace{1.625em} $\bigcdot$ \hspace{.15em} 10907 18 Avenue NW, Edmonton, AB, T6J 6K3
