...
\href{https://www.linkedin.com/in/eguo1}{\textcolor{black}{linkedin.com/in/eguo1}}
    \hspace{.15em} $\diamond$ \hspace{.15em}
\href{https://eddieguo.ca}{\textcolor{black}{eddieguo.ca}}
\end{center}
...
\begin{itemize}
    ...
    \item Published 31 peer-reviewed publications (14 first-author); USMLE Step 1 (Pass)
    \item Awarded grants from OpenAI, Microsoft, Calgary Department of Surgery, and Calgary Students' Union to develop large language model software platforms for medical education and clinical practice
\end{itemize} \vspace{1em}

\textbf{New College, University of Oxford} \hfill 2021 \\
\textit{Study Abroad, Magnetic Resonance Imaging and Stem Cell Engineering} \hfill First Class Honours \vspace{1em}
...
\begin{itemize}
    \item Top GPA in cohort; top of class in multivariable/vector calculus, English critical analysis, and organic chemistry II
    \item Awarded grants for research on nerve regeneration and combining artificial intelligence with rehabilitation exoskeletons
\end{itemize}

\section*{\textcolor{my_colour}{Leadership and Volunteering}}
\vspace{-.25em} \hrulefill \vspace{.25em}

\textbf{OSCE-GPT} \hfill Feb 2023 -- Present \\
\textit{Co-Creator and Principal Software Developer}
\begin{itemize}
    \item Created \href{https://oscegpt.com/}{OSCE-GPT}, an AI-powered app that offers communications and medical management practice with images, medical documentation, and feedback; 6,000+ users in 60+ countries
    \item Solely responsible for the entire development lifecycle of the application, including coding, testing, deployment, and outreach for use in medical and nursing education curricula across Canada
...
\begin{itemize}
    ...
    \item Spearheaded the first professional development and pedagogy training program for 17 undergraduate teachers across Canada
...
% ================================== RESEARCH ==================================
\section*{\textcolor{my_colour}{Research}}
\vspace{-.25em} \hrulefill \vspace{.25em}
...
\begin{itemize}
    ...
    \item Designing machine learning-driven platforms for surgical devices and education, e.g., a surgeon's force profile
...
\begin{enumerate}
    \item \textbf{E. Guo}, M. Gupta, H. Rossong, L. Boone, B. Manoranjan, S. Ahmed, I. Stukalin, S. Lama, G. Sutherland$^*$, ``Healthcare Spending vs Mortality in CNS Cancer: Has Anything Changed?'' \textit{Neuro-Oncology Practice} [accepted].
...
\begin{enumerate}
    \item ``The Role of Artificial Intelligence in Geriatric Medicine Education,'' \textit{Canadian Geriatrics Society Annual Scientific Meeting}, Calgary, AB, Canada, Apr. 26, 2024.
    \item ``IEEE Humangineering Series: Changing the Medical Landscape with LLMs,'' \textit{IEEE Sight, Schulich School of Engineering, University of Calgary}, Jan. 11, 2024.
\end{enumerate} \vspace{1em}

\textbf{Conferences \& Presentations} (of 16) \vspace{.5em}

\begin{enumerate}
    \item I. Ma$^*$, \textbf{E. Guo}, M. Gupta, O. Chen, M. Vergouwen, B. Chiang, M. Paget, C. Naugler, A. Harvey, ``Using large language models to automate literature screening in undergraduate medical program evaluation,'' \textit{International Congress on Academic Medicine 2024}, Vancouver, BC, Canada, Apr. 12-15, 2024 [accepted].
...
% ================================== RESEARCH GRANTS ================================== 
\section*{\textcolor{my_colour}{Selected Research \& Social Innovation Grants} \normalfont (of 15)}
\vspace{-.25em} \hrulefill \vspace{.25em}
...
\textbf{Mach-Gaensslen Foundation: Undergraduate Summer Student Research Award} \hfill Feb 2024
\begin{itemize}
    \item Awarded for ``Development and Use of a Novel Large Language Model (LLM) for the Management of Terminal Brain Cancers''
\end{itemize} \vspace{1em}
...
\begin{itemize}
    \item Awarded to create an interactive app for dermatology trainees to practice oral examinations
\end{itemize}

% \textbf{CFMS Student Initiative Grant} \hfill Mar 2023
% \begin{itemize}
%     \item Awarded to incorporate artificial intelligence into undergraduate medical education
% \end{itemize} \vspace{1em}

% \textbf{Social Innovation Micro Grant} \hfill Mar 2023
% \begin{itemize}
...
\textbf{Alberta Innovates COVID-19 Hackathon Post-Secondary Student Award (\$500)} \hfill Apr 2020
\begin{itemize}
...
\begin{itemize}
    ...
    \item Received USA Fencing A16 ranking (highest ranking in USA Fencing) \hfill 2016
...
\begin{enumerate}
    \item Calgary Department of Clinical Neurosciences 2022-2023 Annual Report: \href{https://cumming.ucalgary.ca/departments/dcns/about/annual-reports}{The AI will see you shortly} (p.22-23) \hfill Mar 2024
