...
\begin{itemize}
    ...
    \item Awarded OpenAI and Mach-Ganesslen Foundation grant to investigate clinical large language models
    \item Published 20 peer-reviewed publications (10 first-author); USMLE Step 1 (Pass)
...
\begin{itemize}
    ...
    \item Collaborating with \textit{Medical schools} -- McMaster, Ottawa; \textit{Neurosurgery programs} -- across the country; \textit{Dermatology residents} -- Calgary, Toronto; \textit{Ophthalmology residents} -- Toronto, McGill; \textit{Allied Health} -- Alberta Association of Nurses, Manitoba nursing, SAIT respiratory therapy
