...
setwd('/Users/eddieguo/Desktop/tig3r66.github.io/assets/downloads/carms_match_rates')

# 2021
df <- as_tibble(read_csv('carms_match_rate_2021.csv'))
...
# 2020
df20 <- as_tibble(read_csv('carms_match_rate_2020.csv'))
...
# 2019
df19 <- as_tibble(read_csv('carms_match_rate_2019.csv'))
...
# 2018
df18 <- as_tibble(read_csv('carms_match_rate_2018.csv'))
...
# 2018-2021
dftot <- as_tibble(read_csv('carms_match_rate_2018_21.csv'))
